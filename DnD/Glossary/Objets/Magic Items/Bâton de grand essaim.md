...
**Sorts**. Tant que vous tenez le bâton, vous pouvez l'utiliser, en prenant une action pour dépenser plusieurs de ses charges, afin de lancer l'un des sorts suivants tout en utilisant votre propre DD des sorts : [*insecte géant*](https://www.aidedd.org/dnd/sorts.php?vf=insecte-geant) (4 charges) ou [*fléau d'insectes*](https://www.aidedd.org/dnd/sorts.php?vf=fleau-d-insectes) (5 charges).  
