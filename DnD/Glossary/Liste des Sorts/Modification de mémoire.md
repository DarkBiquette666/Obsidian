...
Un sort de [*délivrance des malédictions*](https://www.aidedd.org/dnd/sorts.php?vf=delivrance-des-maledictions) ou de [*restauration supérieure*](https://www.aidedd.org/dnd/sorts.php?vf=restauration-superieure) lancé sur la cible restaure la véritable mémoire de la créature.
