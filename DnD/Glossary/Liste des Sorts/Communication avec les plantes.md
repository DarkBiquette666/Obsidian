...
Ce sort peut obliger les plantes créées par le sort [*enchevêtrement*](https://www.aidedd.org/dnd/sorts.php?vf=enchevetrement) à relâcher une créature entravée.