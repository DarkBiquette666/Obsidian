...
***Effets ciblés***. Les sorts et autres effets magiques, tels que [*projectile magique*](https://www.aidedd.org/dnd/sorts.php?vf=projectile-magique) ou [*charme-*](https://www.aidedd.org/dnd/sorts.php?vf=charme-personne) *[personne](https://www.aidedd.org/dnd/sorts.php?vf=charme-personne)*, qui ciblent une créature ou un objet dans la sphère n'ont aucun effet sur la cible. ***Zones de magie***. La zone d'un autre sort ou d'un effet magique, tel que [*boule de feu*](https://www.aidedd.org/dnd/sorts.php?vf=boule-de-feu), ne peut s'étendre dans la sphère. Si la sphère se superpose à une zone de magie, la partie commune est réprimée. Par exemple, les flammes créées par un [*mur de feu*](https://www.aidedd.org/dnd/sorts.php?vf=mur-de-feu) sont réprimées à l'intérieur de la sphère, créant ainsi une ouverture dans le mur, si la portion commune est suffisamment grande.  
***Sorts***. Tout sort ou autre effet magique actif sur une créature ou un objet dans la sphère est réprimé pendant qu'il y est.  
***Objets magiques***. Les propriétés et les pouvoirs des objets magiques sont réprimés dans

la sphère. Par exemple, une épée longue \+1 présente dans la sphère fonctionne comme une épée longue ordinaire.
...
***Dissipation de la magie***. Les sorts et les effets magiques tel que [*dissipation de la magie*](https://www.aidedd.org/dnd/sorts.php?vf=dissipation-de-la-magie) n'ont aucun effet sur la sphère. De même, les sphères créées par des sorts de *champ antimagie* ne s'annulent pas l'une l'autre.