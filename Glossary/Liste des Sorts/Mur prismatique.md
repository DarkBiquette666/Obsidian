...
**Temps d'incantation** : 1 action **Portée** : 18 mètres **Composantes** : V, S  
**Durée** : 10 minutes
...
Le mur peut être détruit, une couche à la fois dans l'ordre indiqué ci-dessous (du rouge au violet), et d'une manière spécifique pour chaque couche. Une fois qu'une couche est détruite, elle le reste pour toute la durée du sort. [*Champ antimagie*](https://www.aidedd.org/dnd/sorts.php?vf=champ-antimagie) n'a aucun effet sur le mur et [*dissipation de la magie*](https://www.aidedd.org/dnd/sorts.php?vf=dissipation-de-la-magie) n'affecte que la couche violette.
