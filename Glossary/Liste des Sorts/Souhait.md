...
**Temps d'incantation** : 1 action **Portée** : personnelle **Composantes** : V  
**Durée** : instantanée
...
* Vous permettez à un maximum de vingt créatures que vous pouvez voir de récupérer tous leurs points de vie et vous dissipez tous les effets les affectant, comme décrit dans le sort [*restauration supérieure*](https://www.aidedd.org/dnd/sorts.php?vf=restauration-superieure).  
