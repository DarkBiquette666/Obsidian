...
school: invocation
aliases:
  - "Convocations instantanées de Drawmijs"
...
Le sort [*dissipation de la magie*](https://www.aidedd.org/dnd/sorts.php?vf=dissipation-de-la-magie), ou un effet similaire, lancé avec succès sur le saphir met fin à l'effet du sort.