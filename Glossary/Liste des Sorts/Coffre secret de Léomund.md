...
**Composantes** : V, S, M (un coffre raffiné de 90 cm x 60 cm x 60 x cm, fabriqué à partir de matériaux rares d'une valeur d'au moins 5 000 po, et une réplique de ce coffre en taille TP, dans les mêmes matériaux, d'une valeur d'au moins 50 po) **Durée** : instantanée
