...
school: divination
domain_spells:
  - "[[Glossary/Liste des Sorts/Lumière]]"
  - "[[Savoir]]"
aliases:
  - "Scrutations"
  - "scrutation"
...
**Composantes** : V, S, M (un focaliseur d'une valeur d'au moins 1 000 po, comme une boule de cristal, un miroir en argent, ou une vasque remplie d'eau bénite) **Durée** : concentration, jusqu'à 10 minutes
...
|  Connaissance Seconde main (vous avez entendu parler de la cib | Modificateur au jet de sauvegarde le)	\+5 |
| :---- | ----- |
...
| :---- | ----- |
| Un portrait ou un dessin Une possession ou un vêtement | −2 −4 |
