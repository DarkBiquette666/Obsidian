...
traits:
  - name: Description
    description: "Un doberman svelte au pelage noir bleuté mat. Ses pattes sont feutrées, étouffant le moindre bruit."
  - name: Personnalité
    description: "Extrêmement silencieux, il ne grogne jamais. Il fixe sa proie avec une intensité glaçante et obéit aux signes de la main."
  - name: Odorat aiguisé
