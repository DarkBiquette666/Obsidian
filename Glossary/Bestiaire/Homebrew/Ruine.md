...
traits:
  - name: Description
    description: "Un dogue massif aux rides profondes. Il possède une force de mâchoire capable de broyer du bois de chêne."
  - name: Personnalité
    description: "Calme en apparence, il devient une véritable démolisseuse vivante au combat. Son lien avec Roc est fusionnel."
  - name: Odorat aiguisé
