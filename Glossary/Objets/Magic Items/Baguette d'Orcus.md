...
**Propriétés aléatoires**. La baguette possède un certain nombre de [propriétés déterminées](https://www.aidedd.org/règles/objets-magiques/artefacts/) [aléatoirement](https://www.aidedd.org/règles/objets-magiques/artefacts/) :
...
**Protection**. Vous gagnez un bonus de \+3 à votre Classe d'Armure tant que vous tenez la baguette. **Sorts**. La baguette possède 7 charges. Tant que vous la tenez, vous pouvez utiliser une action pour dépenser 1 ou plusieurs de ses charges pour lancer l'un des sorts suivants (sauvegarde DD 18\) : [*animation des morts*](https://www.aidedd.org/dnd/sorts.php?vf=animation-des-morts) (1 charge), [*flétrissement*](https://www.aidedd.org/dnd/sorts.php?vf=fletrissement) (2 charges), [*cercle de mort*](https://www.aidedd.org/dnd/sorts.php?vf=cercle-de-mort) (3 charges), [*doigt de mort*](https://www.aidedd.org/dnd/sorts.php?vf=doigt-de-mort) (3 charges), [*mot de pouvoir mortel*](https://www.aidedd.org/dnd/sorts.php?vf=mot-de-pouvoir-mortel) (4 charges) ou [*communication avec les morts*](https://www.aidedd.org/dnd/sorts.php?vf=communication-avec-les-morts) (1 charge). La baguette récupère 1d4 \+ 3 charges dépensées chaque jour à l'aube.  
...
**Appel de morts-vivants**. Tant que vous tenez la baguette, vous pouvez utiliser une action pour invoquer des squelettes et des zombis, en appelant suffisante pour que le total de leurs points de vie cumulés de dépasse pas 500, chaque mort-vivant possédant ses points de vie moyens (voir les statistiques du squelette et du zombi). Les morts-vivants sortent par magie de terre, ou de toute autre forme, dans des espaces inoccupés situés dans un rayon de 90 mètres autour de vous et obéissent à vos ordres jusqu'à ce qu'ils soient détruits ou jusqu'à la aube du jour suivant, ils tombent alors en petits monticules d'os et de chair pourrie inanimée. Une fois que vous avez utilisé cette propriété de la baguette, vous ne pouvez plus la réutiliser avant la prochaine aube.  
Tant qu'il est lié à la baguette, Orcus peut invoquer n'importe quel type de mort-vivant, pas uniquement des squelettes et des zombis. Les morts-vivants ne sont pas détruits ni ne disparaissent à l'aube du jour suivant, ils restent en « vie » jusqu'à ce qu'Orcus les renvoie.  
...
Pour atteindre plus facilement les objectifs de son maître, la baguette feint une dévotion totale pour son utilisateur secondaire et lui fait de mirifiques promesses qu'elle n'aucunement l'intention de tenir, comme par exemple lui jurer de l'aider à renverser Orcus.  
