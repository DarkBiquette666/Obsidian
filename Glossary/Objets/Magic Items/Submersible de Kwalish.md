...
Cet objet apparait d'abord comme un grand baril de fer étanche pesant 250 kg. Le baril à un loquet caché qui peut être trouvé sur un jet d'Intelligence (Investigation) DD 20 réussi. Relâcher le loquet déverrouille une trappe à une extrémité du fût, permettant à deux créatures de taille M ou inférieure de ramper à l'intérieur. Dix leviers sont alignés à l'autre extrémité, chacun dans une position neutre et pouvant être actionné vers le haut ou vers le bas. Quand certains leviers sont utilisés, l'appareil se transforme pour ressembler à un homard géant.

## Caractéristiques du submersible
...
| Levier | Position haute | Position basse |
|--------|---|---|
...
| 4 | Deux pinces se déploient de chaque côté de la face de l'appareil. Chaque pince déployée effectue l'attaque au corps à corps suivante : +8 à l'attaque, allonge 1,50 m, une cible. | Les pinces se rétractent. |
| 5 | Dégâts : 7 (2d6) contondant. | Chaque pince déployée effectue l'attaque au corps à corps suivante : +8 à l'attaque, allonge 1,50 m, une cible. Dégâts : contrôle : La cible est agrippée (DD 15 pour s'échapper). |
