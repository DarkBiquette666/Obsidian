...
Lorsque vous portez cette bague dans une zone de lumière faible ou de ténèbres, vous pouvez jeter [*lumières dansantes*](https://www.aidedd.org/dnd/sorts.php?vf=lumieres-dansantes) et [*lumière*](https://www.aidedd.org/dnd/sorts.php?vf=lumiere) depuis l'anneau à volonté. Lancer un de ces deux sorts depuis l'anneau nécessite une action.  
L'anneau à 6 charges pour les propriétés suivantes. L'anneau récupère 1d6 charges dépensées chaque jour à l'aube.  
**Lucioles**. Vous pouvez dépenser 1 charge par une action pour lancer [*lueurs*](https://www.aidedd.org/dnd/sorts.php?vf=lueurs-feeriques) *[féeriques](https://www.aidedd.org/dnd/sorts.php?vf=lueurs-feeriques)* depuis l'anneau.  
